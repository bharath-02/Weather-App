...
class App extends Component {
    ...
    setWeather = () => {
        ...
        const URL = API_URL + `?q=${city}&appid=890f03a59198b102bc8834a8f3bc5d46&units=metric`;
        this.setState({
            weatherDetails: {},
            loading: true,
            error: false
        ...
        return (
            <div className={classes.AppWrapper}>
                <Header 
                    ...
                    color={mapping.colors[(this.state.error) ? "error" : this.state.weatherDetails.description]}
